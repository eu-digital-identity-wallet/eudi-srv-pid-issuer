...
* `resource_signing_alg_values_supported` JWS Algorithms used by pid-issuer to sign issued Credentials
* `authorization_details_types_supported`: Authorization Details types supported by pid-issuer
