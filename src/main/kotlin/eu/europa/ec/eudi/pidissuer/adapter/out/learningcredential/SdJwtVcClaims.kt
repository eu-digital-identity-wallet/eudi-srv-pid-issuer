...
object SdJwtVcClaims {
    ...
    val AchievementTitle: ClaimDefinition =
        ClaimDefinition(
    ...
    val AchievementDescription: ClaimDefinition =
        ClaimDefinition(
    ...
    val AssessmentGrade: ClaimDefinition =
        ClaimDefinition(
    ...
    val LanguageOfClasses: ClaimDefinition =
        ClaimDefinition(
    ...
    val LearnerIdentification: ClaimDefinition =
        ClaimDefinition(
    ...
    val ExpectedStudyTime: ClaimDefinition =
        ClaimDefinition(
    ...
    val LevelOfLearningExperience: ClaimDefinition =
        ClaimDefinition(
    ...
    val TypesOfQualityAssurance: ClaimDefinition =
        ClaimDefinition(
    ...
    val PrerequisitesToEnroll: ClaimDefinition =
        ClaimDefinition(
    ...
    val IntegrationStackabilityOptions: ClaimDefinition =
        ClaimDefinition(
