...
class KeycloakOauthClientTest {

    companion object {
        val issuerURI = URI("http://localhost:8180/realms/pid-issuer-realm")

        // a public client:
        val clientID = ClientID("pid-issuer")
    ...
    @Order(4)
    @ValueSource(strings = [
        "eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJMRjAtdVltNDJWRW5JeDhXa0lMcHpwdVoxRHNYanpmeHVPa1R4YXlMR0xNIn0..loAgbvSjhhkJ8vYr6pAri1qkgkOfCU9s8-AeA-TqcZluZqYingnULTnAzZtJIx5BG-JadZookJqb4qTuYVAZmDEljHdoTckL9FepUGzbHWo-QEu_gDdc_G2pTOADwWjTxLR1VcOyOSmUkgKo0Q1zdsOrwc7XLGQM7VTLpDdP8Q6W89ubLGJTZXb9rYfTs0Q11blnm-r4E6Fq29225tUq1BVKQLXoiGg2cDBUOXubeRvFqu83P6tFBrqSbpL3yTYZN1wlJ2i6Go8shBXs-7t0pqD7fPy3x0uKYB_4gqj4Udzu4hTN3kLY6gWGHVYpPsfryzXHe3xo5vKuqTvo-ksBDA"
    ])
    fun testGetUserInfo(accessToken: String) {
        ...
        assert(userInfoResponse.indicatesSuccess()) {
            "UserInfoRequest failed, status code: ${httpResponse.statusCode}, status message: ${httpResponse.statusMessage}, content: ${httpResponse.content}"
        }
    ...
    @Order(9) @ParameterizedTest()
    @ValueSource(strings = [
        "eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJMRjAtdVltNDJWRW5JeDhXa0lMcHpwdVoxRHNYanpmeHVPa1R4YXlMR0xNIn0..GjHz63b5ZEdCdY_Qo4DFbYW8zWry_9Nr_Y09IIPs3RNaS_9-ijyBrIEBKhVIPvi5ETTyKlfBaLz6APhR9UyGg1bPPRvQ5Q_1rZhLH6YKFz4LTF870AYtBsNSqlNEQXYhU6lPcsBrA3a3f_NDvYmhrp7iSCZQYZtlXaf3HS6Fd7-mLo5evbq_xajYWnrieDJhhCkj2cpd4RdSZ4j_UuH9_09QlPxiBxsu2oJIjVmCIWyyOpzJvHajq0hG6SlhCpi-_knd-AfLCUr--8xHHGwPewylfFrVlx9p-L9TJUv2qJc7B3ILzwW6npmwMMhtKlzTbHMoOdw0G05MXrD1GKXVqg"
    ])
    ...
    fun testPrintAccessToken() {
        val atoken = "eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJMRjAtdVltNDJWRW5JeDhXa0lMcHpwdVoxRHNYanpmeHVPa1R4YXlMR0xNIn0..kYiKXF7xYj5rJkfKJf5OgDn1t-2ZYxHMmecnVLLSLWI7WPVVj18pmM5Cir-XwCy4RRSXmWQSwJ87hNIcoJFy1j2cm6Zu8NhWThSVTKp9UcGi2k1x0kDLKiRoJ92e2oSZL8TeKQpBGXceErICqiRxIvT4qnoQG_FEV2zGfQKfXFQSO9syBWbm9XRWFNJctZAs5n7hq-UQmK_mtQi-EbQsREPsdzNwgcYFm7ntaZjn2CuRxvtg_0wNTZZNHDX9j4IRfCMihzchKW4PiYs28OTqAukIWmnQdCWgCkT7J7Tknzn77PMfGI5YcL6RJfpfH_0TRqhSjSRmdQWmnA58Z0yOTA"
    ...
    private fun getAuthorizationCodeUsingPAR() {
        ...
        assert (response.indicatesSuccess()) {
            "PAR request failed, statusCode: ${response.toErrorResponse().errorObject.httpStatusCode}, code: ${response.toErrorResponse().errorObject.code}, description: ${response.toErrorResponse().errorObject.description}"
        }
    ...
    private fun getAccessTokenByAuthorizationCode(authorizationCode: String) {
        ...
        assert(httpTokenResponse.indicatesSuccess()) {
            "TokenRequest failed, status code: ${httpTokenResponse.statusCode}, status message: ${httpTokenResponse.statusMessage}, content: ${httpTokenResponse.content}"
        }
